...
/**
 * Adds Schema pallete to the sidebar
 */
Sidebar.prototype.addSchemaPalette = function(expand)
{
	...
	this.addPaletteFunctions('schema', 'Schema Entities', expand || false, fns);	
